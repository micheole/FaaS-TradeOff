...
#
# Usage:
#   ./limitations/time-limited/trigger_function.sh <path_to_config_yaml>
#
# Description:
...
echo "===================================================================="
echo " Time-Limited Trigger: Starting benchmark with config '${CONFIG_NAME}' and provider '$PROVIDER'"
echo "===================================================================="
...
for INPUT_PARAM in "$INPUT_PARAM1" "$INPUT_PARAM2"; do
  ...
  TEMP_ARTILLERY_CONFIG="limitations/time-limited/temp_artillery_config_${CONFIG_NAME}_${PROVIDER}_${INPUT_PARAM}_${UNIQUE_ID}.yaml"
...
echo "===================================================================="
echo " Time-Limited Trigger: All Artillery runs completed for '${CONFIG_NAME}' and provider '${PROVIDER}'."
echo "===================================================================="
